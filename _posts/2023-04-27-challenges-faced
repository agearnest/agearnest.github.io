...
Another challenge I faced was choosing an appropriate test size that would yield accurate results. I chose a 20-30% range since a smaller test size may result in unreliable estimates of model performance. I tried 20% and 30%, but found that 20% yielded better results.
...
Overall, this project allowed me to experiment with different methods to obtain better and more accurate results in order to choose the best model with the most appropriate dataset after alterations.
